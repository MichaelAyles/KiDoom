#!/usr/bin/env python3
"""
ScopeDoom - Oscilloscope-style DOOM Renderer

Renders DOOM as vector graphics suitable for oscilloscope display.
Based on the KiDoom wireframe renderer.
"""
...
class ScopeRenderer:
    """Oscilloscope-style wireframe renderer for DOOM."""
    ...
    def _clear_framebuffer(self):
        ...
        if os.path.exists(self.framebuffer_dir):
            ...
            print(f"[OK] Cleared old screenshots from {self.framebuffer_dir}/")
    ...
    def _handle_screenshot_request(self, sdl_path):
        ...
        try:
            ...
            if self._combine_screenshots(python_path, sdl_path, combined_path):
                print(f"[OK] Combined screenshot saved: {combined_path}")
    ...
    def init_pygame(self):
        ...
        pygame.display.set_caption("ScopeDoom - Oscilloscope Renderer")
    ...
    def render_frame(self):
        ...
        if not frame:
            text = self.font.render("Waiting for DOOM...", True, COLOR_TEXT)
